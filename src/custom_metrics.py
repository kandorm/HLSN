...
def hamming_score(y_true, y_pred, toggle_output=False):
    ...
    '''
    if type(y_true) == list or y_true.ndim == 1:
        y_true = np.expand_dims(y_true, axis=0)
    if type(y_pred) == list or y_pred.ndim == 1:
...
# https://github.com/prdwb/UserIntentPrediction/blob/master/neural_models/custom_metrics.py
